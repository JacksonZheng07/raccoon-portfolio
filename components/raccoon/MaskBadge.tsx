    ...
    >
      <svg viewBox="0 0 40 40" className="h-5 w-5">
        <g fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M 9 13 C 7 8 9 3 13 4 C 16 5 17 8 17 12" fill="var(--color-surface, #fffdf5)"/>
          <path d="M 31 13 C 33 8 31 3 27 4 C 24 5 23 8 23 12" fill="var(--color-surface, #fffdf5)"/>
          <path d="M 8 15 C 8 9 13 6 20 6 C 27 6 32 9 32 15 C 32 22 28 27 25 30 C 23 32 21 33 20 33 C 19 33 17 32 15 30 C 12 27 8 22 8 15 Z" fill="var(--color-surface, #fffdf5)"/>
          ...
          <circle cx="13" cy="17.5" r="3" fill="var(--color-surface, #fffdf5)" stroke="none"/>
          <circle cx="27" cy="17.5" r="3" fill="var(--color-surface, #fffdf5)" stroke="none"/>

  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M 86 190 C 56 210 40 250 34 318 L 268 318 C 264 250 250 204 232 182 C 200 150 120 150 86 190 Z" fill="var(--color-surface, #fffdf5)" stroke="none"/>
        ...
        {/* head */}
        <path d="M 100 96 C 118 72 182 68 212 92 C 236 110 240 150 232 178 C 224 212 198 240 168 248 C 150 252 132 246 122 232 C 112 226 100 224 98 210 C 96 196 106 188 102 172 C 94 152 80 140 84 124 C 86 108 92 100 100 96 Z" fill="var(--color-surface, #fffdf5)"/>
        
        {/* ears */}
        <path d="M 100 96 C 88 76 82 58 92 52 C 104 46 124 62 132 82" fill="var(--color-surface, #fffdf5)"/>
        <path d="M 102 84 C 98 74 98 66 102 62"/>
        <path d="M 212 92 C 222 72 234 58 242 62 C 250 68 246 86 236 100" fill="var(--color-surface, #fffdf5)"/>
        ...
        {/* eyes */}
        <path d="M 108 146 C 108 138 114 133 120 133 C 127 133 132 138 132 146 C 132 154 127 159 120 159 C 114 159 108 154 108 146 Z" fill="var(--color-surface, #fffdf5)"/>
        <circle cx="121" cy="147" r="3.5" fill="currentColor" stroke="none"/>
        <path d="M 182 144 C 182 136 188 131 195 131 C 202 131 207 136 207 144 C 207 152 202 157 195 157 C 188 157 182 152 182 144 Z" fill="var(--color-surface, #fffdf5)"/>
